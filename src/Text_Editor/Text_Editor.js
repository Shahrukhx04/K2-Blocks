...
registerBlockType( 'k2/text-editor', {
	...
	edit( { attributes, setAttributes } ) {
		...
		const EditorMarginSettings = {
			...
			width: attributes.EditorWidgetWidth + '%',
		...
		function myFunction(value) {
			...
			var oferts = document.querySelectorAll(".k2-te-popup-text .components-color-picker__inputs-wrapper");
			...
			<InspectorControls>
				...
				<PanelBody title={'Typography'}>
					...
					<PanelRow>
						...
						<div className="k2-te-popup">
							<span style={{backgroundColor: attributes.EditorTextColor}} className={ 'k2-te-dot' } onClick={ myFunction }>
							</span>
							<span className="k2-te-popup-text"  hidden={ true }>
								<div>
									<ColorPicker
										color={ attributes.EditorTextColor }
					...
					<PanelRow>
						...
						<div className="k2-te-popup">
							<span style={{backgroundColor: attributes.EditorBackgroundColor}} className={ 'k2-te-dot' } onClick={ myFunction }>
							</span>
							<span className="k2-te-popup-text"  hidden={ true }>
								<div>
									<ColorPicker
				...
				<PanelBody title={'Styles'}>
					...
					<PanelRow>
						...
						<div className="k2-te-popup">
							<span style={{backgroundColor: attributes.EditorBorderColor}} className={ 'k2-te-dot' } onClick={ myFunction }>
							</span>
							<span className="k2-te-popup-text"  hidden={ true }>
								<div>
									<ColorPicker

...
function Magik_Builder_Category( $categories, $post ) {
	return array_merge(
		$categories,
		array(
			array(
...
function progressbar_cgb_block_assets() { // phpcs:ignore
	// Register block styles for both frontend + backend.
	wp_register_style(
		'progressbar-cgb-style-css', // Handle.
	...
	wp_register_script(
		'progressbar-cgb-block-js', // Handle.
	...
	wp_register_style(
		'progressbar-cgb-block-editor-css', // Handle.
	 ...
	 */
	register_block_type(
		'cgb/block-progressbar', array(
			// Enqueue blocks.style.build.css on both frontend & backend.
			'style'         => 'progressbar-cgb-style-css',
			// Enqueue blocks.build.js in the editor only.
			'editor_script' => 'progressbar-cgb-block-js',
			// Enqueue blocks.editor.build.css in the editor only.
			'editor_style'  => 'progressbar-cgb-block-editor-css',
		)
	);
}
